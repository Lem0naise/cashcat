...
export default function SpendingActivityDemo() {
    ...
    // Chart state - Default to shorter time range for activity view
    const [timeRange, setTimeRange] = useState<'7d' | '30d' | 'mtd' | '3m' | 'ytd' | '12m' | 'all' | 'custom'>('30d');
            ...
            <div className="bg-white/[.02] rounded-lg border border-white/[.05] p-6">
                <div className="text-center text-white/60 py-12">
                    ...
                    <p className="text-sm max-w-md mx-auto">
                        To see the interactive spending activity chart, you'll need to add some transactions first.
                    </p>
                </div>
            </div>
        );
    ...
    return (
        <div className="bg-white/[.02] rounded-lg border border-white/[.05] p-4 md:p-6 space-y-6">
            <div className="text-center mb-4">
                <h3 className="text-lg font-semibold text-green mb-2">🔴 Live Demo: Spending Activity Chart</h3>
                <p className="text-white/70 text-sm">
                    This is your actual spending activity chart. Hover over the colored segments to see the detailed breakdowns described in this guide.
                </p>
            </div>
            ...
            {/* Spending Activity Chart - We need to show this specifically in volume/activity mode */}
            ...
            <div className="text-center pt-4 border-t border-white/[.05]">
                <p className="text-white/50 text-xs">
                    💡 Try changing the filters above to see how the chart segments change automatically
                </p>
            </div>
        </div>
    );
