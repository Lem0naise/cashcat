/**
 * SankeyPageClient — the full interactive Sankey page UI.
 * This is the client-side portion, extracted so the parent page.tsx
 * can be a Server Component that runs the ProGate check.
 */
'use client';
...
export default function SankeyPageClient() {
