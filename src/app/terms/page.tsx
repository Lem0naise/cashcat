            ...
            <main className="max-w-4xl mx-auto">
                ...
                <div className="bg-blue-500/[.1] border border-blue-500/[.2] rounded-lg p-6 mb-6 text-white/90">
                    ...
                    <ul className="space-y-2 text-sm list-disc list-inside">
                        ...
                        <li>Contact us at legal@indigonolan.com for any questions</li>
                    </ul>
                ...
                <div className="bg-white/[.02] rounded-lg p-6 space-y-6 text-white/80">
                    ...
                    <section>
                        ...
                        <p>For the purposes of UK GDPR and data protection law, the data controller for your personal information is CashCat, on behalf of Indigo Nolan, contactable at legal@indigonolan.com. As the data controller, we are responsible for deciding how and why your personal data is processed.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>For questions about this Privacy Policy, your data, or to request data deletion or export, please contact us through the app's support feature, or via legal@indigonolan.com. We are committed to responding to privacy-related inquiries promptly and transparently.</p>
                    </section>
                    ...
                    <section>
                        ...
                        <p>To exercise any of these rights, please contact us at legal@indigonolan.com. We will respond to your request and provide the requested information free of charge, unless the request is manifestly unfounded or excessive.</p>
                    </section>
